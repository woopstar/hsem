...
| **Excess Battery Export**      | Forces battery discharge to export excess capacity to the grid when economically beneficial.                        | Maximizing revenue from excess solar energy and preventing wasted battery capacity.                                    |
