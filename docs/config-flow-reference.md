...
| Wind chill reference °C | `hsem_ml_consumption_wind_chill_reference_temperature` | 18.0    | Balance-point temperature (°C) above which wind no longer increases heat loss. Only used when wind chill is enabled.                                                                                                                                |
