...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    # working_mode_sensor._hsem_huawei_solar_device_id_inverter_1 = get_config_value(
    #     config_entry, "hsem_huawei_solar_device_id_inverter_1"
    # )
    # working_mode_sensor._hsem_huawei_solar_device_id_inverter_2 = get_config_value(
    #     config_entry, "hsem_huawei_solar_device_id_inverter_2"
    # )
    # working_mode_sensor._hsem_huawei_solar_device_id_batteries = get_config_value(
    #     config_entry, "hsem_huawei_solar_device_id_batteries"
    # )
    # working_mode_sensor._hsem_huawei_solar_batteries_working_mode = get_config_value(
    #     config_entry, "hsem_huawei_solar_batteries_working_mode"
    # )
    # working_mode_sensor._hsem_huawei_solar_batteries_state_of_capacity = get_config_value(
    #     config_entry, "hsem_huawei_solar_batteries_state_of_capacity"
    # )
    # working_mode_sensor._hsem_house_consumption_power = get_config_value(
    #     config_entry, "hsem_house_consumption_power"
    # )
    # working_mode_sensor._hsem_solar_production_power = get_config_value(
    #     config_entry, "hsem_solar_production_power"
    # )
    # working_mode_sensor._hsem_solcast_pv_forecast_forecast_today = get_config_value(
    #     config_entry, "hsem_solcast_pv_forecast_forecast_today"
    # )
    # working_mode_sensor._hsem_ev_charger_status = get_config_value(config_entry, "hsem_ev_charger_status")
    # working_mode_sensor._hsem_ev_charger_power = get_config_value(config_entry, "hsem_ev_charger_power")

    # working_mode_sensor._hsem_battery_max_capacity = get_config_value(
    #     config_entry, "hsem_battery_max_capacity"
    # )
    # working_mode_sensor._hsem_energi_data_service_import = get_config_value(
    #     config_entry, "hsem_energi_data_service_import"
    # )
    # working_mode_sensor._hsem_energi_data_service_export = get_config_value(
    #     config_entry, "hsem_energi_data_service_export"
    # )
    # working_mode_sensor._hsem_huawei_solar_inverter_active_power_control = get_config_value(
    #     config_entry, "hsem_huawei_solar_inverter_active_power_control"
    # )
    # working_mode_sensor._hsem_huawei_solar_batteries_maximum_charging_power = get_config_value(
    #     config_entry, "hsem_huawei_solar_batteries_maximum_charging_power"
    # )
    # working_mode_sensor._hsem_battery_conversion_loss = get_config_value(
    #     config_entry, "hsem_battery_conversion_loss"
    # )
    # working_mode_sensor._hsem_house_power_includes_ev_charger_power = get_config_value(
    #     config_entry, "hsem_house_power_includes_ev_charger_power"
    # )
    # working_mode_sensor._hsem_morning_energy_need = get_config_value(
    #     config_entry, "hsem_morning_energy_need"
    # )
    # working_mode_sensor._hsem_huawei_solar_batteries_grid_charge_cutoff_soc = get_config_value(
    #     config_entry, "hsem_huawei_solar_batteries_grid_charge_cutoff_soc"
    # )
    # working_mode_sensor._hsem_huawei_solar_batteries_tou_charging_and_discharging_periods = get_config_value(
