...
DEFAULT_CONFIG_VALUES = {
    ...
    "hsem_huawei_solar_device_id_tou_controller": vol.UNDEFINED,
    ...
    # Charging-profile rate unit preference: auto negotiates from the
    # charger's reported ChargingScheduleAllowedChargingRateUnit (watts
    # preferred); amps/watts force a unit (issue #1001).
    "hsem_ocpp_charging_rate_unit": "auto",
    ...
    "hsem_ocpp_second_charging_rate_unit": "auto",
