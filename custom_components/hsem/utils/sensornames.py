...
def get_energy_average_sensor_unique_id(hour_start: int, hour_end: int, avg: int) -> str:
    """
    ...
    """
    return f"{DOMAIN}_house_consumption_energy_avg_{hour_start:02d}_{hour_end:02d}_{avg}d"
